...
const EventSchema = new mongoose_1.Schema({
    ...
    Attendees: { type: [mongoose_1.default.Types.ObjectId], ref: "Users" },
    RegisteredUsers: [
        {
...
exports.EventModel = mongoose_1.default.models.AdminModel || mongoose_1.default.model("Event", EventSchema);
